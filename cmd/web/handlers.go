...
func (app *application) loginUser(w http.ResponseWriter, r *http.Request) {
	...
	app.session.Put(r, "flash", "Successful")
...
func (app *application) changePassword(w http.ResponseWriter, r *http.Request) {
	...
	form.Password("newPassword", "confirmPassword")
	if !form.Valid() {
		app.render(w, r, "password.page.tmpl", &templateData{Form: form})
	}
	err = app.users.ChangePassword(app.session.Get(r, "authenticatedUserID").(int), form.Get("currentPassword"), form.Get("newPassword"))
	if err != nil {
		if errors.Is(err, models.ErrInvalidCredentials) {
